...
const GuardiansListComponent = function GuardiansList({
  ...
  const [expandedGuardians, setExpandedGuardians] = useState<Set<number>>(
    new Set(),
  );
...
const GuardianFormItem = memo(
  function GuardianFormItem({
    index,
    isExpanded,
    onToggle,
    onRemove,
    ...
    const handleAddressChange = useCallback(
      (
        ...
        const currentGuardian = currentValues.guardians?.[index] as
          | GuardianFormData
          | undefined;
        ...
        if (addressData.address !== undefined) {
          setValue(`guardians.${index}.address`, addressData.address, {
            shouldDirty: true,
            shouldValidate: true,
            shouldTouch: true,
          });
        ...
        if (addressData.city !== undefined) {
          setValue(`guardians.${index}.city`, addressData.city, {
            shouldDirty: true,
            shouldValidate: true,
            shouldTouch: true,
          });
        ...
        if (addressData.zipcode !== undefined) {
          setValue(`guardians.${index}.zipcode`, addressData.zipcode, {
            shouldDirty: true,
            shouldValidate: true,
            shouldTouch: true,
          });
        ...
        if (addressData.country !== undefined) {
          ...
          setValue(`guardians.${index}.country`, addressData.country, {
            shouldDirty: true,
            shouldValidate: true,
            shouldTouch: true,
          });
    ...
    return (
      <Controller
        ...
        render={({ field: guardianField }) => {
          ...
          const guardianValue = (guardianAddressFields ||
            guardianField.value ||
            {}) as GuardianFormData;
                ...
                <div className="p-3 space-y-3">
                  ...
                  <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                    ...
                    <div className="grid gap-2">
                      <Label
                        className="text-xs"
                        htmlFor={`guardian-lastname-${index}`}
                      >
                        Apellido *
                      </Label>
                      <Input
                      ...
                      render={({ field }) => (
                        <PhoneInput
                          ...
                          onChange={(value) => {
                            ...
                            setValue(`guardians.${index}.phone`, value, {
                              shouldDirty: true,
                              shouldTouch: true,
                              shouldValidate: true,
                            });
                          ...
                          defaultCountry={
                            addressData.country
                              ? (getCountryCode(addressData.country) as
                                  | CountryCode
                                  | undefined)
                              : undefined
                          }
